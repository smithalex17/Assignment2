...
public class AStar {
    ...
    public static double heuristic(Stop current, Stop goal) {
        ...
        double h = current.distance(goal);
        return h;
    }
